...
class SystemIdTest {
    ...
    void testValidSystemId() {
        SystemId systemId = SystemId.of(1L);
        assertEquals(1L, systemId.value());
    }

    @Test
    void testValidSystemIdLargeNumber() {
        SystemId systemId = SystemId.of(999999999L);
        assertEquals(999999999L, systemId.value());
    }

    @Test
    void testInvalidSystemIdNull() {
        NullPointerException exception = assertThrows(NullPointerException.class, () -> SystemId.of(null));
    ...
    void testInvalidSystemIdLargeNegative() {
        DomainException exception = assertThrows(DomainException.class, () -> SystemId.of(-999999L));
        assertEquals("SystemId deve ser um número positivo", exception.getMessage());
    }

    @Test
    void testSystemIdEquality() {
        SystemId systemId1 = SystemId.of(123L);
        SystemId systemId2 = SystemId.of(123L);
        SystemId systemId3 = SystemId.of(456L);
    ...
    void testSystemIdToString() {
        SystemId systemId = SystemId.of(12345L);
    ...
    void testSystemIdValue() {
        ...
        SystemId systemId = SystemId.of(expectedValue);
    ...
    void testDifferentSystemIdsNotEqual() {
        SystemId systemId1 = SystemId.of(1L);
        SystemId systemId2 = SystemId.of(2L);
    ...
    void testSystemIdImmutability() {
        SystemId systemId = SystemId.of(100L);
    ...
    void testSystemIdWithMaxLong() {
        ...
        SystemId systemId = SystemId.of(Long.MAX_VALUE);
